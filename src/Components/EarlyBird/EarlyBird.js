...
function EarlyBird({countdownTimestampMs}) {
  ...
  return (
    <section className="bg-gradient py-8 md:py-16 bird-container">
          ...
          <div className="flex items-center flex-col md:flex-row -mx-5">
            <div className="w-full px-5 mb-5 md:mb-0 text-center md:text-left">
              ...
              <div className="mt-4 w-full md:w-44">
                <button type="button" className=" early-button py-2 px-4  hover:bg-gray-100  text-indigo-500 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                  Early bird
                </button>
              </div>
            </div>
